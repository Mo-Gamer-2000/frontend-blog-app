        ...
        <section className="bg-dark-hard">
            <footer className="container mx-auto grid grid-cols-10 px-5 py-10 gap-y-10 gap-x-5 md:pt-20 md:grid-cols-12 lg:grid-cols-10 lg:gap-x-10">
                ...
                <div className="col-span-10 md:order-first md:col-span-4 lg:col-span-2">
                    <a href="/"><img src={images.Logo} alt="logo" className="brightness-120 mx-auto md:mx-0 rounded-xl w-36" /></a>
                    <p className="text-sm text-dark-light text-center mt-4 md:text-left md:text-base lg:text-sm">
                        Build a modern and creative website using MERN.
                    </p>
                ...
                <div className="hidden md:flex flex-col items-center space-y-4 md:col-span-12 lg:col-span-10">
                    ...
                    <p className="font-bold italic text-xl text-white">
                        Copyright © 2023. Reserved by Moeez Abdul.
                    </p>
                </div>
            </footer>
        </section>
